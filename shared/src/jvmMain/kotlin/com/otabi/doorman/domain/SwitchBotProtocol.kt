...
actual class SwitchBotProtocol actual constructor(
    ...
    actual fun parseStatus(mfrData: ByteArray): DoorStatus {
        ...
        // Mask with 0xFF to safely convert the signed byte to a positive integer (0-255)
        counter = mfrData[4].toInt() and 0xFF
        
        return if ((mfrData[6].toInt() and 0x01) == 0) DoorStatus.OPEN else DoorStatus.CLOSED
    }
}